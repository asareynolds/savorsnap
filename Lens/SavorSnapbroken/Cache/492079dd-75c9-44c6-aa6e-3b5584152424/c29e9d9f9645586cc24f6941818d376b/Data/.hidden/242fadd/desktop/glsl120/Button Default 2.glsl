...
#endif
vec4 l9_16=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,l9_15,l9_14,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
vec4 l9_17=l9_16*baseColor;
float l9_18=l9_17.w;
...
#endif
l9_34=sc_SampleView(sc_ScreenTextureDims.xy,l9_38,sc_ScreenTextureLayout,l9_39,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_40;
